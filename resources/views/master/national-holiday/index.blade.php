...
@section('title')
    {{ __('National Holiday') }} | {{ config('app.name') }}
@endsection
        ...
        <div class="kt-portlet__body">
            <div class="kt-portlet__content">
                ...
                @if (Laratrust::isAbleTo('create-master'))
                    <a href="{{ route('master.national-holiday.create') }}" class="btn btn-primary mb-4">
                        <i class="fa fa-plus"></i> {{ __('New National Holiday') }}
                    </a>
                @endif
...
@section('script')
    @include('layouts.inc.modal.delete', ['object' => 'national holiday'])
    ...
    <script type="text/javascript">
        $('#kt_table_1').DataTable({
            ...
            ajax: {
                method: 'POST',
                url: '{{ route('master.national-holiday.data') }}',
                headers: {
