        ...
        <div class="kt-portlet__body">
            <div class="kt-portlet__content">
                ...
                @if (Laratrust::isAbleTo('create-master'))
                    <a href="{{ route('master.leave-type.create') }}" class="btn btn-primary mb-4">
                        <i class="fa fa-plus"></i> {{ __('New Leave Type') }}
                    </a>
                @endif
...
@section('script')
    @include('layouts.inc.modal.delete', ['object' => 'leave type'])
    ...
    <script type="text/javascript">
        $('#kt_table_1').DataTable({
            ...
            ajax: {
                method: 'POST',
                url: '{{ route('master.leave-type.data') }}',
                headers: {
