        ...
        <div class="kt-portlet__body">
            <div class="kt-portlet__content">
                ...
                @if (Laratrust::isAbleTo('create-master'))
                    <a href="{{ route('master.skill.create') }}" class="btn btn-primary mb-4">
                        <i class="fa fa-plus"></i> {{ __('New Skill') }}
                    </a>
                @endif
...
@section('script')
    @include('layouts.inc.modal.delete', ['object' => 'skill'])
