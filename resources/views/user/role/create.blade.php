...
@section('breadcrumb')
    ...
    <span class="kt-subheader__breadcrumbs-separator"></span><a href="{{ route('role.create') }}"
        class="kt-subheader__breadcrumbs-link">{{ __('Create') }} {{ __('Role') }}</a>
@endsection
                            ...
                            <div class="kt-section__body">
                                ...
                                <div class="form-group form-group-last">
                                    ...
                                    <input id="nama" name="nama" type="text"
                                        ...
                                        placeholder="{{ __('role_name') }}" value="{{ old('nama') }}">
                                                    ...
                                                    <span
                                                        ...
                                                        <label class="mb-0">
                                                            <input type="checkbox" value="{{ $permission->id }}"
                                                                ...
                                                                {{ old('hak_akses.' . $group . '.' . $i) == $permission->id ? 'checked' : '' }}>
                                                            <span class="m-0"></span>
                                                        </label>
                                                    </span>
                                                </td>
